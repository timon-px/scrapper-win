...
public class UniqueizerConstants {
    public static final String UNIQUE_HTML_NAME = "index_unique.html";
    ...
    public static final Set<String> EXCLUDED_TAGS = Set.of("html", "head", "body", "script", "style", "link", "meta");
